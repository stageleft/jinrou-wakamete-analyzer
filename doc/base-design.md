...
配役（{auto-calc}人）： 村{auto-calc}占[x]狩[x]霊[x]共[x]猫[x] 狼[x]狂[x] 狐[x]背[x]小[x]
...
* 日付のポップアップ 同日昼および前日夜の全発言
* キャラのポップアップ 全日・該当キャラの発言
* comments 発言数  
...
　「村　人」「人　外」「人　狼」「狂　人」「妖　狐」「子　狐」 
  ...
  Remark：「狂信者」「背徳者」などは、プレイヤー側で適宜用いて読み替えるようにする。この場合、各々「狂　人」「子　狐」などがよい。
* Job-target / Job-result   
  下表のとおりとするが、入力フィールドは「選択」のみ用意する。

| deduced Job | Job-target | Job-result |
|--------|-----------------|-------------|
|「村　人」<br>「共有者」<br>「猫　又」|なし|なし|
|「占い師」|選択：自分以外の生存者|選択：「○」「●」|
|「霊能者」|固定：前日の吊り先|選択：「○」「●」「△」※△は子狐専用|
